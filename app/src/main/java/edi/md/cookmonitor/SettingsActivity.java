...
//        enLang = findViewById(R.id.select_lng_en);
        ...
        categories_spiner.add(getResources().getString(R.string.spinner_Manual));
        categories_spiner.add("10 " + getResources().getString(R.string.spinner_Secconds));
        categories_spiner.add("15 " + getResources().getString(R.string.spinner_Secconds));
        categories_spiner.add("30 " + getResources().getString(R.string.spinner_Secconds));
        categories_spiner.add("1 " + getResources().getString(R.string.spinner_Minutes));
